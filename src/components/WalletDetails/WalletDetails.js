...
const WalletDetails = ({balance, setIsWalletDetails, setIsDarkMode, isDarkMode, setIsLogout, setIsAudio, isAudio, setIsLeaderboard, counter, isNotification, setActiveModal, setIsNotification }) => {
